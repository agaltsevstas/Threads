...
namespace ATOMIC
{
    ...
    void Start()
    {
        ...
        /*
         ...
         - std::atomic переменная number2 имеет одну операцию с lock сигналом на уровне процессора, гарантирующая, что к кэш линии, в которой лежит number2, эксклюзивно имеет доступ только ядро, выполняющее эту инструкцию.
         */
        {
            int number1 = 0;
